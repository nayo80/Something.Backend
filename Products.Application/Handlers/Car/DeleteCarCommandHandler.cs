...
public class DeleteCarCommandHandler(ICarRepository repository,IElasticSearchService productSearchService) : IRequestHandler<DeleteCarCommand,BaseResponse<bool>>
{
    public async Task<BaseResponse<bool>> Handle(DeleteCarCommand request, CancellationToken cancellationToken)
    {
        ...
        await productSearchService.DeleteProductAsync(request.Id);
